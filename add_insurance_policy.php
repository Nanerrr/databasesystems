...
if(isset($_POST['Submit'])) {
	...
	$result = mysqli_query($mysqli, "INSERT INTO insurance_policy(policy_id, name, phone, policy_type, policy_coverage, premium, start_date, end_date, company_name) VALUES('$policy_id', '$name', '$phone', '$policy_type', '$policy_coverage', '$premium', '$start_date', '$end_date', '$company_name')");
